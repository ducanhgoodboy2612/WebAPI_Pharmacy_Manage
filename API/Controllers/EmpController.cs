...
namespace API.Controllers
{
    ...
    public class EmpController : ControllerBase
    {
        ...
        public EmpController(IEmpBusiness empBusiness, IConfiguration configuration, IWebHostEnvironment env)
        {
        ...
        [Route("create-emp")]
        [HttpPost]
        public EmployeeModel CreateItem([FromBody] EmployeeModel model)
        {
            _empBusiness.Create(model);
            return model;
        }
